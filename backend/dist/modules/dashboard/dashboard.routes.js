...
export const dashboardRoutes = new Hono()
    ...
    const [totalEmployees, activeEmployees, employees, attendanceRecords, pendingLeaves, pendingAdvances, pendingLoans, pendingDocuments, openTasks, activeProjects, payrollRecords, leaveRequests, advanceRequests, loanRequests, documentRequests, recentEmployees, priorityTasks, announcements,] = await Promise.all([
    ...
    const attendanceByEmployee = new Map(attendanceRecords.map((attendance) => [attendance.userId, attendance]));
    ...
    const payroll = payrollRecords.reduce((totals, payment) => ({
